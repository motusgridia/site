...
excerpt: "Every codex entry carries a flag: grounded, fiction-c1, or fiction-c2. Grounded entries describe what the network actually does. Fiction entries are narrative. C1 and C2 are two source concepts, not time periods. This explains the split."
cover_image: null
