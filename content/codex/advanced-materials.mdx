...
related_codex: [wireless-power, e-hair, grid-network, grids-platform, asteroid-mining, hubs, honeycomb-architecture, advanced-pcs-in-walls, printed-villages, media-production-tech, energy-level-bands, plasma-crystal-swords, aura-and-photons, cooling-tubes]
first_seen_log: null
