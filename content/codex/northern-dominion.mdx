...
related_codex: [off-grid, on-grid-faction, cyber-vikings, the-hive, e-hair, dj-panz, awol-androids, neutral-zone-militia, plasma-crystal-swords, alien-bacterium, off-grid-megacities, bounty-game-map]
first_seen_log: null
