...
Emergency Services is the only standing power the Grid Network lets itself hold. Everything else (the [Hubs](/codex/hubs), the Magway, the Reward Banks) is logistical. ES is how the network enforces its one non-negotiable rule: protect the people living next to you. The rest of the system only works because ES is there, and the force ES can bring only works because the rest of the system is there to watch it.
