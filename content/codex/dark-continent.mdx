...
first_seen_log: null
summary: "The arc after the Earth invasion fails. Humans launch a counter-invasion of the alien homeworld. Rebels on both sides converge. The utopia the Grids imagined for Earth gets tested, at scale, against what it actually is — an evolution of Grids, or a mirror of the same extraction problem."
hero_image: null
hero_3d: null
---
